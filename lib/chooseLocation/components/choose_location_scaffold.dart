...
import 'appBarComponents/appBar_search.dart';
import 'appBarComponents/return_button.dart';
    ...
    return Scaffold(
      ...
      floatingActionButton: Padding(
        ...
        child: FloatingActionButton(
          ...
          onPressed: () {
            // getHttp(
            //     'https://maps.googleapis.com/maps/api/place/autocomplete/json?input=amoeba&location=37.76999%2C-122.44696&radius=500&strictbounds=true&types=establishment&key=AIzaSyCBtN4E2qfNz_Ek95CkjrtoZ1ps-ExRqX8');
